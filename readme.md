...
- `blog` - optional, mandatory if repository supports article and is not explanatory enought without supporting content
- `<name-of-blog-or-example>` - mandatory, should be descriptive or alligned with the blogpost name
